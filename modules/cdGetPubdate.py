...
def getPubdate(url, outputArray, indexOfOutputArray, verbose=False, **kwargs):
    ...
    for meta in soup.findAll("meta"):
        ...
        # <meta name="timestamp"  data-type="date"
        # content="2015-11-25 22:40:25" />
        ...
        # content="2015-11-26T00:10:33+00:00">
        if 'bt:pubdate' == metaProperty or 'og:pubdate' == metaProperty:
            metaDate = meta['content'].strip()
            break
        # <meta name="sailthru.date"
        # content="2015-11-25T19:56:04+0000" />
        if 'sailthru.date' == metaName:
            metaDate = meta['content'].strip()
            break

        # <meta name="article.published"
        # content="2015-11-26T11:53:00.000Z" />
        ...
        # content="Thursday, November 26, 2015,  6:42 AM" />
